    ...
    for epo in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if step % 100 == 0:
                ...
                tb_writer.add_scalar("evalerr", tr_loss/global_step, global_step=global_step) 
...
def main():
    ...
    # REPLICATE PRETRAINING
    # args = parser.parse_args()
    args = torch.load("./pretrained_hug_models/dicadd/checkpoint-12864/training_args.bin")
    args.la_layers = 9
    print(args)
    args.philly = False
    # END REPLICATE
